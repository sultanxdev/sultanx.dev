...
export const siteConfig = {
  ...
  title: 'Sultan Portfolio',
  description: 'Sultan Portfolio Template by @Sultanxdev',
...
export const pageMetadata: Record<string, PageMeta> = {
  ...
  // Journey page
  '/journey': {
    title: 'Journey - My Path in Tech',
    description:
      'A timeline of my professional journey, achievements, and technical growth over the years.',
    keywords: [
      'career journey',
      'tech path',
      'milestones',
